var CPU = {
    ...
    switch (CPU.STATE) {
      case 0:
        setState(
          1,
          "Ciclo de captación:",
          " La *Unidad de Control* copia el valor del *Contador de programa* en el *registro de direccion de memoria* y luego este se coloca en el *bus de direcciones*"
        );
      ...
      case 1:
        setState(
          2,
          "Ciclo de captación:",
          "La *Unidad de Control* coloca la dirección del MAR en el *Bus de Direcciones* y luego este se carga el valor almacenado en el *Bus de Datos*."
        );
        $(".active").removeClass("active");
      ...
      case 2:
        setState(
          3,
          "Ciclo de captación:",
          "La *Unidad de Control* almacena el valor del *Bus de Datos* en el *MBR*."
        );
      ...
      case 3:
        setState(
          4,
          "Ciclo de captación:",
          "La *Unidad de Control* incrementa el *PC* en 1"
        );
        CPU.REGISTERS.PC++;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 4:
        setState(
          5,
          "Ciclo de captación:",
          "La *Unidad de Control* copia el valor del *MBR* en el *IR*."
        );
      ...
      case 5:
        setState(
          ...
          "El *decodificador* obtiene el *codop* y el *operando* del *IR*"
        );
        $(".active").removeClass("active");
      ...
      case 7:
        setState(
          71,
          "Decodificación de instrucción",
          "El *IR* envía el *dirección de memoria* a la *MAR* y a su vez este lo envia al *Bus de Direcciones*."
        );
      ...
      case 71:
        setState(
          72,
          "Ciclo de ejecución",
          "La *unidad de control* le indica a la *memoria* que busque la dirección y coloque el valor en el *bus de datos*"
        );
        $(".active").removeClass("active");
        $("#ram_value_" + CPU.REGISTERS.MAR).addClass("active");
        break;
      case 72:
        setState(
          73,
          "Ciclo de ejecución",
          "La *unidad de control* coloca el valor del *bus de datos* en el *MBR*"
        );
        CPU.REGISTERS.MBR = CPU.RAM[CPU.REGISTERS.MAR];
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 73:
        setState(
          74,
          "Ciclo de ejecución",
          "La *MBR* guardará el valor del primer operando en el primer registro del Banco de registros"
        );
      ...
      case 77:
        setState(
          78,
          "Ciclo de ejecución",
          "La *MBR* guardará el valor del primer operando en el segunda registro del Banco de registros"
        );
      ...
      case 78:
        setState(
          27,
          "Ciclo de ejecución",
          "La *unidad de control* le indica a la *ALU* que sume el valor de *R1* y de *R2*. El resultado lo coloca de nuevo en el *acumulador"
        );
      ...
      case 8:
        setState(
          81,
          "Decodificación de instrucción",
          "El *decodificador* envía el *codop* al *MAR* y a su vez este lo envia al *Bus de Direcciones*."
        );
        CPU.REGISTERS.MAR = CPU.REGISTERS.IR & 0x0f;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 87:
        setState(
          88,
          "Ciclo de ejecución",
          "La *MBR* guardará el valor del primer operando en el segundo registro del Banco de registros"
        );
        CPU.REGISTERS.R2 = CPU.REGISTERS.MBR;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 12:
        setState(
          121,
          "Ciclo de ejecución",
          "El *decodificador* envía el *la dirección de memoria* y a su vez este lo envía al *Bus de Direcciones*."
        );
        CPU.REGISTERS.MAR = CPU.REGISTERS.IR & 0x0f;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 123:
        setState(
          27,
          "Ciclo de ejecución",
          "La *unidad de control* le indica a la ALU que reste el valor presente en la *MBR* en 1"
        );
      ...
      case 133:
        setState(
          27,
          "Ciclo de ejecución",
          "La *unidad de control* le indica a la ALU que sume el valor presente en la *MBR* en 1"
        );
        CPU.REGISTERS.EAX = CPU.REGISTERS.MBR + 1;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 24:
        setState(
          27,
          "Ciclo de ejecución",
          "El *bus de control* lee el *dispositivos de entrada* y coloca el dato en el *acumulador*"
        );
        CPU.REGISTERS.EAX =
          parseInt(prompt("Ingresar valor decimal:")) & 0xffff;
        CPU.updateRegisters();
        $(".active").removeClass("active");
      ...
      case 25:
        setState(
          27,
          "Ciclo de ejecución",
          "El *bus de control* envia el valor del *acumulador* al *dispositivo de salida*"
        );
      ...
      case 27:
        setState(
          271,
          "Decodificación de instrucción",
          "La *unidad de control* envia el valor del *acumulador* al *MBR*"
        );
      ...
      case 271:
        setState(
          272,
          "Decodificación de instrucción",
          "El *decodificador* envia el *operando* al *MAR* y este lo envia al *Bus de direcciones*"
        );
        CPU.REGISTERS.MAR = CPU.REGISTERS.IR & 0x0f;
      ...
      case 272:
        setState(
          0,
          "Ciclo de ejecución",
          "La *unidad de control* le dice a la memoria que guarde el valor que se encuentra en el *bus de datos* en la dirección que se encuentra en el *bus de direcciones*"
        );
      ...
      case 29:
        setState(
          7,
          "Ciclo de ejecución",
          "Se ha *detenido* la ejecución del programa"
        );
        $(".active").removeClass("active");
        CPU.RUNNING = false;
        break;
  ...
  drawRamButtons: function (html) {
    ...
    html +=
      '<button type="button" class="btn btn_values btn-secondary" id="btn_values_binary"> Binario</button>';
    html +=
      '<button type="button" class="btn btn_values btn-secondary" id="btn_values_denary">  Decimal </button>';
    html +=
      '<button type="button" class="btn btn_values btn-secondary" id="btn_values_hex"> Hex </button></div>';
    return html;
  },
  ...
  drawDecoder: function (html) {
    ...
    html +=
      '<table class="table table-fixed table-striped table-hover"><thead><tr><th>Codop</th><th>Operando</th><th>Instrucción</th></tr></thead>';
    html +=
      '<tr class="decode_row_0"><td>00000</td><td>00000</td><td>ADD</td></tr>';
    html +=
      '<tr class="decode_row_1"><td>00001</td><td>dirección</td><td>SUB</td></tr>';
    html +=
      '<tr class="decode_row_2"><td>00010</td><td>dirección</td><td>MUL</td></tr>';
    html +=
      '<tr class="decode_row_3"><td>00011</td><td>dirección</td><td>DIV</td></tr>';
    html +=
      '<tr class="decode_row_4"><td>00100</td><td>dirección</td><td>MOV</td></tr>';
    html +=
      '<tr class="decode_row_5"><td>00101</td><td>dirección</td><td>DEC</td></tr>';
    html +=
      '<tr class="decode_row_6"><td>00110</td><td>dirección</td><td>INC</td></tr>';
    html +=
      '<tr class="decode_row_7"><td>00111</td><td>dirección</td><td>CMP</td></tr>';
    html +=
      '<tr class="decode_row_8"><td>01000</td><td>dirección</td><td>JZ</td></tr>';
    html +=
      '<tr class="decode_row_9"><td>01001</td><td>dirección</td><td>JNZ</td></tr>';
    html +=
      '<tr class="decode_row_10"><td>01010</td><td>dirección</td><td>NOT</td></tr>';
    html +=
      '<tr class="decode_row_11"><td>01011</td><td>dirección</td><td>AND</td></tr>';
    html +=
      '<tr class="decode_row_12"><td>01100</td><td>dirección</td><td>OR</td></tr>';
    html +=
      '<tr class="decode_row_13"><td>01101</td><td>dirección</td><td>JA</td></tr>';
    html +=
      '<tr class="decode_row_14"><td>01110</td><td>dirección</td><td>JAE</td></tr>';
    html +=
      '<tr class="decode_row_15"><td>01111</td><td>dirección</td><td>JB</td></tr>';
    html +=
      '<tr class="decode_row_16"><td>10000</td><td>dirección</td><td>JBE</td></tr>';
    html +=
      '<tr class="decode_row_17"><td>10001</td><td>00001</td><td>IN</td></tr>';
    html +=
      '<tr class="decode_row_18"><td>10010</td><td>00010</td><td>OUT</td></tr>';
    html +=
      '<tr class="decode_row_19"><td>10011</td><td>dirección</td><td>LOAD</td></tr>';
    html +=
      '<tr class="decode_row_20"><td>10100</td><td>dirección</td><td>STORE</td></tr>';
    html +=
      '<tr class="decode_row_21"><td>10101</td><td>01111</td><td>CLEAR</td></tr>';
    html += "</table></div>";
    return html;
  },
  ...
  drawBus: function (html) {
    html +=
      '<div class="bus_control" id="bus_control"><h4>Bus <br/><br/> de <br/><br/> Control</h4></div>';
    html +=
      '<div class="bus_data" id="bus_datos"><h4>Bus <br/><br/> de <br/><br/> Datos</h4> </div>';
    html +=
      '<div class="bus_address" id="bus_direccion"><h4>Bus <br/><br/> de <br/><br/> Direcciones</h4> </div>';
    return html;
  },
  ...
  drawArrows: function () {
     ...
     */
    // connect(
    //   { e: ALU, h: "left", v: "middle" },
    //   { e: DECODE_UNIT, h: "right" },
    //   { "stroke-width": 10, "arrow-start": "block-narrow-short" }
    // );
    // connect(
    //   { e: ALU, h: "20%", v: "top" },
    //   { e: GENERAL_REGISTERS, v: "bottom" }
    // );

    // connect(
    //   { e: ALU, h: "right", v: "bottom" },
    //   { e: MBR, h: "20%" },
    //   { "stroke-width": 10, "arrow-start": "block-narrow-short" }
    // );
    // connect(
    ...
    // connect(
    //   { e: ALU, h: "right", v: "middle" },
    //   { e: FLAGS, h: "left", v: "middle" }
    // );
    // connect(
    //   { e: PC, h: "right", v: "middle" },
    //   { e: MAR, h: "left", v: "middle" }
    // );
    //connect({ e: DECODE_UNIT, h: "60%", v: "top" }, { e: PC, v: "bottom" });

    // connect(
    //   { e: DECODE_UNIT, h: "79%", v: "top" },
    //   { e: MAR, h: "-376%", v: "200%" },
    //   { "stroke-width": 10 }
    // );
    // connect(
    //   { e: DECODE_UNIT, h: "77%", v: "-9%" },
    //   { e: MAR, h: "middle", v: "195%" },
    //   { "stroke-width": 10 }
    // );
    // connect(
    //   { e: DECODE_UNIT, h: "270%", v: "-10%" },
    //   { e: MAR, h: "45%", v: "bottom" }
    // );

    // connect(
    //   { e: MBR, h: "middle", v: "bottom" },
    //   { e: IR, h: "middle", v: "top" }
    // );
    ...
    //   {
    //     "stroke-width": 10,
    //     "arrow-end": "block-narrow-short",
    //     "arrow-start": "block-narrow-short",
    //   }
    // );
    // connect(
    //   { e: MBR, h: "4%", v: "top" },
    ...
    // );
    // connect(
    //   { e: BUS_CONTROL, h: "left", v: "91%" },
    //   { e: CONTROL_UNIT, h: "right", v: "middle" },
    //   { "stroke-width": 10, "arrow-start": "block-narrow-short" }
    // );
    // connect(
    //   { e: BUS_DIRECCION, h: "left", v: "5%" },
    //   { e: MAR, h: "right" },
    //   { "stroke-width": 10, "arrow-start": "block-narrow-short" }
    // );
    ...
    // connect(
    //   { e: CONTROL_UNIT, h: "-97%", v: "middle" },
    //   { e: ALU, h: "5%", v: "bottom" },
    //   { "stroke-width": 10, "arrow-end": "block-narrow-short" }
    // );
    // connect(
    //   { e: CONTROL_UNIT, h: "left", v: "middle" },
    //   { e: ALU, h: "2%" },
    //   { "stroke-width": 10, "arrow-start": "block-narrow-short" }
    // );
    // connect(
    //   { e: DECODE_UNIT, h: "right", v: "98%" },
    //   { e: CONTROL_UNIT, h: "left", v: "bottom" }
    // );
  },
  ...
  init: function (DOM_CPU) {
    ...
    html +=
      '<table class="table table-fixed table-striped table-hover"><thead><tr><th>Dirección</th><th>Valor</th></tr></thead>';
    ...
    for (var address = 0; address < 16; address++) {
      ...
      console.log(ram);
      html +=
        '<tr><td id="ram_address_' +
        address +
        '" class="value_address value_denary">' +
        address +
        '</td><td id="ram_value_' +
        address +
        '" class="value value_denary editable" data-description="Dirección de memoria ' +
        address +
        '">' +
        CPU.RAM[address] +
        "</td></tr>";
    ...
    function getRegisterHtml(name, value, desc) {
      if (name.toLowerCase() == "pc" || name.toLowerCase() == "mar") {
        return (
          '<div class="register_address" id="reg_' +
          name.toLowerCase() +
          '"><div class="reg_name">' +
          name +
          '</div><div id="reg_' +
          name.toLowerCase() +
          '_val" class="reg_val value value_address value_denary editable" data-description="' +
          desc +
          '">' +
          value +
          "</div></div>"
      ...
      if (["r1", "r2", "r3", "r4", "r5", "r6"].includes(name.toLowerCase())) {
        return (
          '<div class="general_register" id="reg_' +
          name.toLowerCase() +
          '"><div class="reg_name">' +
          name +
          '</div><div id="reg_' +
          name.toLowerCase() +
          '_val" class="reg_val value value_denary editable" data-description="' +
          desc +
          '">' +
          value +
          "</div></div>"
      ...
      if (["of", "cf", "zf"].includes(name.toLowerCase())) {
        return (
          '<div class="flag_register" id="reg_' +
          name.toLowerCase() +
          '"><div class="reg_name">' +
          name +
          '</div><div id="reg_' +
          name.toLowerCase() +
          '_val" class="reg_val value value_flag value_denary editable" data-description="' +
          desc +
          '">' +
          value +
          "</div></div>"
    ...
    $(".value.editable, .value_address.editable, .value_flag.editable").click(
      function (e) {
    ...
    $(".btn_values").click(function (e) {
      ...
      $(".value, .value_address, .value_flag")
        ...
        .removeClass("value_binary value_denary value_hex")
        .addClass("value_" + mode);
    });
