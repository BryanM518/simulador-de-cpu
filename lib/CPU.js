		...
		switch(CPU.STATE){
			...
			case 6:
				...
				switch(codop) {
					...
					case 19:
						setState(26, "Decodificación de instrucción", "*codop 10011* ->  LOAD"); //BORRAR
						break;

					case 20:
						setState(27, "Decodificación de instrucción", "*codop 10100* ->  STORE"); //BORRAR
						break;
					
					case 21:
						setState(28, "Decodificación de instrucción", "*codop 10101* ->  CLEAR"); //BORRAR
						break;
				...
				//MOVE
				case 11:
					setState(111, "Ciclo de ejecución", "El *decodificador* envía el *codop* al *MAR* y a su vez este lo envia al *Bus de Direcciones*.");
					CPU.REGISTERS.MAR = CPU.REGISTERS.IR & 0x0F
					CPU.updateRegisters();
					$('.active').removeClass('active');
					$('#reg_mar,.decode_row_1').addClass('active');
