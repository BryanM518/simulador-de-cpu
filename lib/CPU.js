	...
	step: function(){
		...
		switch(CPU.STATE){
			...
			case 6:
				...
				switch(codop) {
					case 0:
						setState(7, "Decodificación de instrucción", "*codop 00000* ->  ADD");
						break;
						
					case 1:
						setState(8, "Decodificación de instrucción", "*codop 00001* ->  SUB");
						break;
						
					case 2:
						setState(9, "Decodificación de instrucción", "*codop 00010* ->  MUL");
						break;
						
					case 3:
						setState(10, "Decodificación de instrucción", "*codop 00011* ->  DIV");
						break;
					...
					case 5:
						setState(12, "Decodificación de instrucción", "*codop 00101* ->  DEC");
						break;
						
					case 6:
						setState(13, "Decodificación de instrucción", "*codop 00110* ->  INC");
						break;
					...
					case 17:
						setState(24, "Decodificación de instrucción", "*codop 10001* ->  IN");
						break;	

					case 18:
						setState(25, "Decodificación de instrucción", "*codop 10010* ->  OUT");
						break;
					...
					case 22:
						setState(29, "Se ha detenido la instrucción", "*copdop 10110* -> END");
				}
				break;

				//ADD
				case 7:
					setState(71, "Decodificación de instrucción", "El *decodificador* envía el *codop* al *MAR* y a su vez este lo envia al *Bus de Direcciones*.");
				...
				case 73:
					...
					var Uop1 = (CPU.REGISTERS.IR & 0x0F);
					var op1 = CPU.RAM[Uop1];
					var Uop2 = (CPU.REGISTERS.IR >> 4) & 0x0F;
					var op2 = CPU.RAM[Uop2];
					
					CPU.REGISTERS.EAX = op1 + op2;
				...
				case 92:
					...
					break;
				case 93:
					setState(27, "Ciclo de ejecución", "La *unidad de control* le indica a la *ALU* que sume el valor del *acumulador* y el *MBR*. El resultado lo coloca de nuevo en el *acumulador");
				...
				case 10:
					...
					CPU.REGISTERS.EAX = Math.floor(op1 / op2);
